...
\maketitle
\begin{abstract}
This article describes the system that participated in the shared task on metaphor detection on the VU Amsterdam Metaphor Corpus (VUA). The task is part of the workshop on processing figurative language at the 16th annual conference of the North American Chapter of the Association for Computational Linguistics (NAACL2018).
...
\fxnote{removed/drastically shorten loosely related quote}
\begin{quotation}
...
\egon{Make use of model.summary()}

\egon{Specify the predefined length of input sentences}

\egon{a few words of explenation: "sequences are padded"}
...
\subsection{Word Embeddings} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\egon{Add a bit of content}

\fxnote{Should we use the/some of the following comment at all?}
